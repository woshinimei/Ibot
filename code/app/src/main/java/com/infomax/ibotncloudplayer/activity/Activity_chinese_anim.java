...
public class Activity_chinese_anim extends FullScreenActivity implements View.OnClickListener {
    TextView tvBack;
    GridView gv;
    ...
    public static final String TAG = Activity_chinese_anim.class.getSimpleName();
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chinese_anim);
        initViews();
        registerReceiver();
        preInitData();
    }
