 ...
 * 不能用于glide加载圆角矩形。会出现om.bumptech.glide.load.resource.drawable.GlideDrawable cannot be cast to ndroid.graphics.drawable.BitmapDrawable
 * @author juying
 *
 */
